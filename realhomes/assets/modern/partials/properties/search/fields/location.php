...
for ( $i = 0; $i < $location_select_count; $i ++ ) {
	?>
    <div class=" <?php echo esc_attr( $parent_class ) ?> inspiry_select_picker_field rh_prop_search__option rh_location_prop_search_<?php echo esc_attr( $i ); ?> rh_prop_search__select"
