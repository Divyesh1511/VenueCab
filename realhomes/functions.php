...
// Theme version.
define( 'INSPIRY_THEME_VERSION', '3.13.1' );
...
if ( ! function_exists( 'inspiry_theme_setup' ) ) {
	...
	function inspiry_theme_setup() {
		...
		add_image_size( 'property-thumb-image', 488, 326, true );               // (3) For Home page po0ts thumbnails/Featured Properties carousels thumb.
...
if ( ! function_exists( 'inspiry_add_editor_style' ) ) :
	...
	function inspiry_add_editor_style() {
		...
		$google_fonts = rubik_google_font_url();
		if ( 'classic' === INSPIRY_DESIGN_VARIATION ) {
			$google_fonts = inspiry_google_fonts();
		}
